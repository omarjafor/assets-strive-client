...
const MaxPendingRequest = () => {
    ...
    const { data: requestedassets, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSecure.get(`/requestedassets/admin/toppending`);
            return res.data;
        }
    })
    ...
    return (
        <div>
            <div className='p-12 lg:px-24 lg:py-5'>
                <DataTable
                    title='Max Pending Requested Items'
                    columns={columns}
...
export default MaxPendingRequest;